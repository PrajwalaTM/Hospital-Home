...
def process(request):
    ...
    if request.method == 'POST':
        ...
        if myform.is_valid():
            ...
            out_file=open('/home/prajwala/Desktop/Hospital-Home/testHeart.csv','w')
            ...
            out_file.close()
            #print ("****RR*****")
            output=subprocess.check_output(['Rscript', '/home/prajwala/Desktop/Hospital-Home/sample.R'], shell=False)
            #print("****R***")
